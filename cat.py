...
def get_destiny_place():
    database = {
        ...
        "화남": [
            ["매운 떡볶이 맛집", "강렬한 매운맛으로 스트레스를 날려버리세요!", "쿨피스 주문은 필수입니다.", "Stray Kids - 락 (樂)", "Linkin Park - Faint"],
            ["야구 연습장", "배트를 휘두르며 답답함을 타격해 보세요!", "장갑을 끼면 손이 덜 아파요.", "윤도현 - 나는 나비", "Survivor - Eye of the Tiger"]
        ],
        "설렘": [
            ["해운대 달맞이길", "낭만적인 풍경과 함께 설레는 마음을 만끽하세요.", "일몰 시간대에 가면 분위기가 최고예요.", "볼빨간사춘기 - 처음부터 너와 나", "Bruno Mars - Just the Way You Are"],
            ["테마파크 관람차", "높은 곳에서 내려다보는 풍경이 심장을 더 뛰게 할 거예요.", "사진 찍기 좋은 명당을 찾아보세요.", "아이유 - 마음", "Taylor Swift - Love Story"]
        ]
    }
